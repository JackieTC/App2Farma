...
public class ActivityInformacion extends FragmentActivity implements
        ActionBar.TabListener {

    private ViewPager viewPager;
    private ActionBar actionBar;
    private AdapterInformacion tabPagerAdapter;
    private String[] tabs = { "Pago", "Quejas", "Cancelacion" };
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.swipetab);
        viewPager = (ViewPager) findViewById(R.id.pager);
        tabPagerAdapter = new AdapterInformacion(getSupportFragmentManager());
