...
public class ActivityCategorias extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        cla = new AdapterCategorias(ActivityCategorias.this);

        // category API url
    	CategoryAPI = Constante.CategoryAPI+"?accesskey="+ Constante.AccessKey;
		...
		listCategory.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int position,
				...
				// go to menu page
				Intent iMenuList = new Intent(ActivityCategorias.this, ActivityProductos.class);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.cart:
			// refresh action
			Intent iMyOrder = new Intent(ActivityCategorias.this, ActivityCarrito.class);
